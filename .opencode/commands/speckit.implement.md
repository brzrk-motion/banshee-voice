---
description: Execute the implementation plan by processing and executing all tasks defined in tasks.md. Use `.opencode/skills/plugin-development/SKILL.md` for plugin-related work.
---
